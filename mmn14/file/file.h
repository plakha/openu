...
3. disregard empty lines (that contain only spacenew line characters) - my GetLine finc is supposed to put one single delimiter in placre of multiple ignorable chars,
